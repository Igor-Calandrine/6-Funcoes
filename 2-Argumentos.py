...
"""Argumentos nomeados
    ...
    A função não mudou, entretanto a ordem dos argumentos foi invetida quando chamamos a função. Porém dizemos  explicitamente a Python a qual parâmetro cada argumento deve corresponder. Quando Python lê a chamada da função, ele sabe onde deve armazenar o argumento."""
